...
const EMBEDDED_STDLIB: &[(&str, &str)] = &[
    ...
    ("http",          concat!(
        include_str!("../../tinox-core-ext/http/Http.tnx"),
        include_str!("../../tinox-core-ext/http/HttpClientResponse.tnx"),
    )),
    ("http_server",   concat!(
        include_str!("../../tinox-core-ext/http_server/HttpContext.tnx"),
        include_str!("../../tinox-core-ext/http_server/HttpRequest.tnx"),
        include_str!("../../tinox-core-ext/http_server/HttpResponse.tnx"),
        include_str!("../../tinox-core-ext/http_server/HttpServer.tnx"),
        include_str!("../../tinox-core-ext/http_server/MediaType.tnx"),
        include_str!("../../tinox-core-ext/http_server/QueryString.tnx"),
        include_str!("../../tinox-core-ext/http_server/Route.tnx"),
        include_str!("../../tinox-core-ext/http_server/RouteMatcher.tnx"),
    )),
    ("io",            concat!(
    ...
    ("json",          concat!(
        include_str!("../../tinox-core-ext/json/Json.tnx"),
        include_str!("../../tinox-core-ext/json/JsonField.tnx"),
        include_str!("../../tinox-core-ext/json/JsonSerializable.tnx"),
        include_str!("../../tinox-core-ext/json/JsonValue.tnx"),
    )),
    ("logger",        concat!(
    ...
    ("client",        concat!(
        include_str!("../../tinox-core-ext/rest/client/HttpStatus.tnx"),
        include_str!("../../tinox-core-ext/rest/client/HttpStatusHelper.tnx"),
        include_str!("../../tinox-core-ext/rest/client/MediaType.tnx"),
        include_str!("../../tinox-core-ext/rest/client/MediaTypeHelper.tnx"),
        include_str!("../../tinox-core-ext/rest/client/RequestBuilder.tnx"),
        include_str!("../../tinox-core-ext/rest/client/RestClient.tnx"),
        include_str!("../../tinox-core-ext/rest/client/RestResponse.tnx"),
        include_str!("../../tinox-core-ext/rest/client/Url.tnx"),
    )),
